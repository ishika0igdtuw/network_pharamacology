...
#'
#' @description
#' This function creates a bar plot to visualize network degrees.
#'
...
#'
#' @param top The number of top categories to show, ordered by P-adjust value.
#' @param text.size The text size for plot labels.
#' @param text.width The width for wrapping text in labels.
#' @param plot.set The orientation of the plot, either "horizontal" or "vertical".
